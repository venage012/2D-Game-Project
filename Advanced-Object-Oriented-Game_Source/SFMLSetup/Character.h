...
public:
	...
	void CharacterUpdate(float _dt, std::vector<Tile*> _Collisions, sf::RectangleShape _Bullet, int& _BoxCount);
	void CharacterInputUpdate(float _dt, std::vector<Tile*> _Collisions, sf::Vector2f _Mouse, sf::RectangleShape _Bullet, int& _BoxCount);
	void PlayerAnimate();
